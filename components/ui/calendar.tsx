  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'flex',
        head_cell:
          'text-gray-500/40 rounded-md w-6 flex-1 font-normal text-[0.8rem] dark:text-neutral-400',
        row: 'flex w-full mt-2',
        cell: cn(
          't relative flex-1 p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-transparent [&:has([aria-selected].day-outside)]:bg-neutral-100/50 [&:has([aria-selected].day-range-end)]:rounded-r-md',
          props.mode === 'range'
