...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('flex flex-col gap-2 p-7 px-4 lg:px-7', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('p-7 px-4 pt-0 lg:px-7 lg:pt-0', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('flex items-center p-7 px-4 pt-0 lg:px-4 lg:pt-0', className)}
    {...props}
  />
))
